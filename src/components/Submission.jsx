  ...
  return (
    <div className="p-4">
      ...
      <ul className="list-disc pl-5">
        <li>The submission should be from 2 to 8 pages long. The paper should follow the <a href="https://ras.papercept.net/conferences/support/tex.php" className="text-blue-500 hover:text-blue-700">IEEE RAS Template</a>.</li>
        ...
        <li>The papers should be submitted on <a href="https://cmt3.research.microsoft.com" className="text-blue-500 hover:text-blue-700">Microsoft CMT</a>.</li>
